...
var mesCumpleaños = meses [meses.length-1];

console.log (mesCumpleaños);    
...
/*Dado los siguientes arrays:
    ...
    var planetas = [
        ...
        Mostrar por la terminal el último elemento de cada array (usando la propiedad length que tienen 
        los arrays).
...
console.log (meses.length + " y " + planetas.length);        
console.log (meses[meses.length-1] + " y " + planetas[planetas.length-1]);
...
/* Dado el siguiente array de nombres:
    ...
    var apellidos = ['Rodriguez', 'López'];
        ...
        Crear un nuevo array llamado nombreCompleto que contenga el segundo elemento del array nombres 
        y el primer elemento del array apellidos. Mostrar el nuevo array por la terminal.*/

var nombres = ["Sofía", "Abril"];
var apellidos = ["Rodriguez", "López"];

console.log(nombres[0] + " y " + apellidos[0]);

var nombreCompleto = [nombres[1], apellidos[1]];
console.log(nombreCompleto);



/* Dado el siguiente array de participantes de una carrera y considerando que están ordenados en base al 
orden de llegada (el primer elemento es el primero en haber llegado):
    ...
    var corredores = [
        ...
        Crear un nuevo array llamado losUltimos que contenga los 2 últimos corredores en llegar
         (usando la propiedad length que tienen los arrays). Mostrar este nuevo array por la terminal.*/
